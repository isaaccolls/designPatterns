...
console.log("ticket.getState:", ticket.getState);
console.log("ticket.next():", ticket.next());
//
console.log("🐢 vamo a agrega 6");
ticket.add(6);
console.log("ticket.getState:", ticket.getState);
console.log("ticket.next():", ticket.next());
//
console.log("🐢 vamo a agrega 4");
ticket.add(4); // no esta lleno falta 1
console.log("ticket.getState:", ticket.getState);
console.log("ticket.next():", ticket.next());
console.log("ticket.next():", ticket.next());
//
console.log("🐢 vamo a agrega 3");
ticket.add(3); // con 3 queda lleno en 5
console.log("ticket.getState:", ticket.getState);
//
console.log("🐢 vamo a agrega 1+");
ticket.add(1); // no se agrega porque ya que esta lleno
//
console.log("🐢 vamo a quitar 1");
console.log("ticket.next():", ticket.next());
console.log("ticket.getState:", ticket.getState);
//
console.log("🐢 vamo a vacia");
console.log("ticket.next():", ticket.next());
console.log("ticket.next():", ticket.next());
console.log("ticket.next():", ticket.next());
console.log("ticket.next():", ticket.next());
